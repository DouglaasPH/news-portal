export default function SobreNosPage() {
    return (
        <main className='pl-10 pr-10 pt-[1vw] h-[80vw] sm:flex justify-between flex-col'>
            {/* Seção: Sobre Nós */}
            <section className="h-[7vw] flex flex-col justify-between">
                <h1 className='text-3xl sm:text-5xl md:text-6xl lg:text-4xl font-bold'>Sobre Nós</h1>
                <p className="ml-1">
            ...
            <section className="h-[9vw] flex flex-col justify-between">
                <h1 className='text-black text-3xl sm:text-5xl md:text-6xl lg:text-4xl font-bold'>O que nos define?</h1>
                <p className="ml-1">
            ...
            {/* Seção: Nossa Missão */}
            <section className="h-[7vw] flex flex-col justify-between">
                <h1 className='text-black text-3xl sm:text-5xl md:text-6xl lg:text-4xl font-bold'>Nossa Missão</h1>
                <p className="ml-1">
            ...
            {/* Seção: Nossa Visão */}
            <section className="h-[7vw] flex flex-col justify-between">
                <h1 className='text-black text-3xl sm:text-5xl md:text-6xl lg:text-4xl font-bold'>Nossa Visão</h1>
                <p className="ml-1">
            ...
            <section className="h-[9vw] flex flex-col justify-between">
                <h1 className='text-black text-3xl sm:text-5xl md:text-6xl lg:text-4xl font-bold'>Nossos Valores</h1>
                <p className="ml-1">
            ...
            {/* Seção: Fale Conosco */}
            <section className="h-[9vw] flex flex-col justify-between">
                <h1 className='text-black text-3xl sm:text-5xl md:text-6xl lg:text-4xl font-bold'>Fale Conosco</h1>
                <p className="ml-1">
